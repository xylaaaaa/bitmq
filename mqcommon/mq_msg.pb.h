...
PROTOBUF_NAMESPACE_OPEN
template<> ::bitmq::BasicProperties* Arena::CreateMaybeMessage<::bitmq::BasicProperties>(Arena*);
template<> ::bitmq::Message* Arena::CreateMaybeMessage<::bitmq::Message>(Arena*);
template<> ::bitmq::Message_Payload* Arena::CreateMaybeMessage<::bitmq::Message_Payload>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace bitmq {
...
class BasicProperties final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bitmq.BasicProperties) */ {
 public:
...
class Message_Payload final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bitmq.Message.Payload) */ {
 public:
...
class Message final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bitmq.Message) */ {
 public:
...
inline const ::bitmq::Message_Payload& Message::_internal_payload() const {
  const ::bitmq::Message_Payload* p = payload_;
  return p != nullptr ? *p : reinterpret_cast<const ::bitmq::Message_Payload&>(
      ::bitmq::_Message_Payload_default_instance_);
}
...
inline ::bitmq::Message_Payload* Message::_internal_mutable_payload() {
  ...
  if (payload_ == nullptr) {
    auto* p = CreateMaybeMessage<::bitmq::Message_Payload>(GetArenaForAllocation());
    payload_ = p;
  }
  return payload_;
}
...
template <> struct is_proto_enum< ::bitmq::ExchangeType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::bitmq::ExchangeType>() {
  return ::bitmq::ExchangeType_descriptor();
}
template <> struct is_proto_enum< ::bitmq::DeliveryMode> : ::std::true_type {};
template <>
