...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::contacts::PeopleInfo, sn_),
  PROTOBUF_FIELD_OFFSET(::contacts::PeopleInfo, name_),
  PROTOBUF_FIELD_OFFSET(::contacts::PeopleInfo, score_),
};
...
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 89, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
...
void PeopleInfo::InternalSwap(PeopleInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PeopleInfo, score_)
      + sizeof(PeopleInfo::score_)
      - PROTOBUF_FIELD_OFFSET(PeopleInfo, sn_)>(
